...
# file reader
original = pad_sequences(get_data_v2("train_source.txt"), value=0, maxlen=30)
paraphrase = pad_sequences(get_data_v2("train_target.txt"), value=0, maxlen=30)
target_paraphrase = manual_one_hot(
    pad_sequences(get_data_v2_offset("train_target.txt"), value=0, maxlen=30))
